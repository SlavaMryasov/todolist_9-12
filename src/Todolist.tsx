...
export const Todolist = memo((props: PropsType) => {
    ...
    let tasks = useMemo(() => props.tasks, [props.tasks])
...
const ButtonMemo = memo(({ variant, onClick, color, title, ...rest }: ButtonMemoType) => {
...
const IconButtonMemo = memo(({ onClick, ...rest }: IconButtonMemoType) => {
